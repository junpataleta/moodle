...
$string['cm_delete_feedback_multi'] = 'The selected {$a->count} activities have been deleted.';
$string['cm_duplicate_feedback'] = '{$a->name} has been duplicated.';
$string['cm_duplicate_feedback_multi'] = 'The selected {$a->count} activities have been duplicated.';
$string['cm_hide_feedback'] = '{$a->name} is now hidden.';
$string['cm_hide_feedback_multi'] = 'The selected {$a->count} activities are now hidden.';
...
$string['cm_show_feedback_multi'] = 'The selected {$a->count} activities are now shown.';
...
$string['section_hide_feedback_multi'] = 'The selected {$a->count} course sections have been hidden.';
$string['section_show_feedback'] = 'The course section {$a->name} has been shown.';
$string['section_show_feedback_multi'] = 'The selected {$a->count} course sections have been shown.';
$string['section_delete_feedback'] = 'The course section {$a->name} has been deleted';
$string['section_delete_feedback_multi'] = 'The selected {$a->count} course sections have been deleted';
