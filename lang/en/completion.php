...
$string['eventcoursecompletionsettingsunlocked'] = 'Course completion settings unlocked';
$string['eventcoursecompletionsettingsunlockeddesc'] = 'The user with id \'{$a->userid}\' unlocked the course completion settings, and deleted existing user completion data, for course with id \'{$a->courseid}\'.';
