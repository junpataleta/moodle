...
$string['completion_automatic:aria:activitydone'] = '{$a} is not yet done';
$string['completion_automatic:aria:activitynotdone'] = '{$a} is done';
$string['completion_automatic:aria:automatictracking'] = 'The completion of {$a} is tracked automatically';
