...
$string['commenttextpurpose'] = 'Stores the text of the comment.';
$string['commenttablepurpose'] = 'Stores comments of users.';
...
$string['timecreatedcommentpurpose'] = 'Time a comment was created.';
...
$string['useridpurpose'] = 'Identifier for a user record.';
