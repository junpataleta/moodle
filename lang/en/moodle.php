...
$string['coursesectiontitlebulkediting'] = 'Bulk editing {$a->sectionname}: {$a->sectiontitle} | {$a->course}';
$string['coursesectiontitleediting'] = 'Editing {$a->sectionname}: {$a->sectiontitle} | {$a->course}';
...
$string['coursetitlebulkediting'] = 'Bulk editing course: {$a->course}';
$string['coursetitleediting'] = 'Editing course: {$a->course}';
