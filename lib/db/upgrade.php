...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2017032400.04) {
        ...
        upgrade_main_savepoint(true, 2017032400.04);
    }

    if ($oldversion < 2017032400.05) {
        ...
        upgrade_main_savepoint(true, 2017032400.05);
    }

    if ($oldversion < 2017032400.06) {
        ...
        upgrade_main_savepoint(true, 2017032400.06);
    }

    if ($oldversion < 2017032400.12) {
        // Create adhoc task for upgrading of existing calendar events.
        $record = new \stdClass();
        $record->classname = "\\core\\task\\refresh_mod_calendar_events_task";
        $record->component = 'core';
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2017032400.12);
    }
