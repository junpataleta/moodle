...
EditorPluginButtons.prototype = {
    ...
    addButton: function(config) {
        ...
        if (config.keys) {
            ...
            this._addKeyboardListener(function(e) {
                this._handleButtonHighlight(e, config.buttonName);
            }, config.keys, buttonClass);
     ...
     * @private
     */
    _handleButtonHighlight: function(e, buttonName) {
    ...
    _changeButtonHighlight: function(highlight, button) {
        ...
        // Save the current button's highlight state.
