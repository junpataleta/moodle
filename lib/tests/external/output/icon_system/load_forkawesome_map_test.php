 ...
 * @coversDefaultClass \core\external\output\icon_system\load_forkawesome_map
 */
class load_forkawesome_map_testcase extends externallib_advanced_testcase {
    ...
    public static function setUpBeforeClass(): void {
        ...
        // The load_forkawesome_map class should not need to supplement our lack of autoloading of these classes.
        require_once($CFG->libdir . '/externallib.php');
    }

    /**
     * Ensure that a valid theme which uses forkawesome returns a map.
     *
     * @covers ::execute_parameters
     * @covers ::execute
     * @covers ::execute_returns
     * @dataProvider valid_forkawesome_theme_provider
     * @param   string $themename
     */
    public function test_execute(string $themename): void {
        $result = load_forkawesome_map::execute($themename);
    ...
    public function test_execute_invalid_themename(): void {
        $result = load_forkawesome_map::execute('invalidtheme');
     ...
     * @return  array
     */
    public function valid_forkawesome_theme_provider(): array {
        return [
            'Boost theme' => ['boost'],
