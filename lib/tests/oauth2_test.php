...
class core_oauth2_testcase extends advanced_testcase {
    ...
    public function test_get_system_oauth_client($responsedata, $expiresin) {
        ...
        // Get the difference between the actual expiry times. They might differ by a couple of seconds depending on the timing
        // when the token gets actually processed.
