...
class core_xapi_request_testcase extends externallib_advanced_testcase {
    ...
    public function test_xapi_statement_post_invalid_params() {
        ...
        try {
            $result = external::post_statement('core_xapi', $json);
        ...
        try {
            $result = external::post_statement('fake_component', $json);
        } catch (invalid_xapi_request_exception $e) {
        ...
        unset($statement->actor->account);
        $statement->actor->member = [xapi_helper::xapi_agent($USER)];
        $json = json_encode($statement);
        try {
            $result = external::post_statement('core_xapi', $json);
        } catch (invalid_xapi_request_exception $e) {
        ...
        $statement = $this->testhelper->generate_statement();
        $statement->verb = xapi_helper::xapi_agent($USER);
        $json = json_encode($statement);
        try {
            $result = external::post_statement('core_xapi', $json);
        } catch (invalid_xapi_request_exception $e) {
        ...
        $statement = $this->testhelper->generate_statement();
        $statement->object = xapi_helper::xapi_agent($USER);
    ...
    public function test_xapi_statement_post_handler() {
        ...
        $statement = $this->testhelper->generate_statement();
        $statement->actor = xapi_helper::xapi_agent($user2);
        $json = json_encode($statement);
        try {
            $result = external::post_statement('core_xapi', $json);
        } catch (invalid_xapi_request_exception $e) {
        ...
        // Invalid verb.
        $statement = $this->testhelper->generate_statement();
        $statement->verb = xapi_helper::xapi_verb('walk');
        $json = json_encode($statement);
        try {
            $result = external::post_statement('core_xapi', $json);
        } catch (invalid_xapi_request_exception $e) {
        ...
        // Invalid IRI verb.
        $statement = $this->testhelper->generate_statement();
        $statement->verb = xapi_helper::xapi_verb('http://adlnet.gov/expapi/verbs/fight');
        $json = json_encode($statement);
        try {
            $result = external::post_statement('core_xapi', $json);
        } catch (invalid_xapi_request_exception $e) {
        ...
        $statement = $this->testhelper->generate_statement();
        $statement->object = xapi_helper::xapi_object('potato_omelette');
        $json = json_encode($statement);
        try {
            $result = external::post_statement('core_xapi', $json);
        } catch (invalid_xapi_request_exception $e) {
        ...
        // Invalid IRI object.
        $statement = $this->testhelper->generate_statement();
        $statement->object = xapi_helper::xapi_object('http://adlnet.gov/expapi/activities/wrong');
        $json = json_encode($statement);
        try {
            $result = external::post_statement('core_xapi', $json);
        } catch (invalid_xapi_request_exception $e) {
    ...
    public function test_xapi_statement_post_array() {
        ...
        $statement1 = $this->testhelper->generate_statement();
        $statement1->verb = xapi_helper::xapi_verb('walk');
        $statement2 = $this->testhelper->generate_statement();
        $statements = [$statement1, $statement2];
        $json = json_encode($statements);
        $result = external::post_statement('core_xapi', $json);
