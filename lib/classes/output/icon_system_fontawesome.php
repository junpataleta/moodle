...
class icon_system_fontawesome extends icon_system_font {
    ...
    public function get_core_icon_map() {
        return [
            ...
            'core:i/risk_config' => 'fa fa-exclamation-triangle text-success',
            'core:i/risk_managetrust' => 'fa fa-exclamation-triangle text-muted',
            'core:i/risk_personal' => 'fa fa-exclamation-triangle text-primary',
            'core:i/risk_spam' => 'fa fa-exclamation-triangle text-warning',
