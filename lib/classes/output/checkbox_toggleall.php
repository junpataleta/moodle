...
class checkbox_toggleall implements renderable, templatable {
     ...
     * @param bool $istoggler Whether we're rendering for a toggler checkbox or a target checkbox.
     ...
     *                                 the toggler will select all of the target checkboxes. Defaults to "Select all".</li>
     *         <li><b>deselectall </b> string - Master only. The language string that will be used to indicate that clicking on
     *                                 the toggler will select all of the target checkboxes. Defaults to "Deselect all".</li>
     *     </ul>
     * @param bool $isbutton Whether to render this as a button. Applies to toggler only.
     */
    public function __construct(string $togglegroup, bool $istoggler, $options = [], $isbutton = false) {
        $this->togglegroup = $togglegroup;
        $this->istoggler = $istoggler;
        $this->options = $options;
        $this->isbutton = $istoggler && $isbutton;
    }
