 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class icon_system_forkawesome extends icon_system_font {
    ...
    public function get_core_icon_map() {
        return [
            ...
            'core:i/risk_config' => 'fa-exclamation-triangle text-success',
            'core:i/risk_managetrust' => 'fa-exclamation-triangle text-muted',
            'core:i/risk_personal' => 'fa-exclamation-triangle text-primary',
            'core:i/risk_spam' => 'fa-exclamation-triangle text-warning',
    ...
    public function get_icon_name_map() {
        if ($this->map === []) {
            $cache = \cache::make('core', 'forkawesomeiconmapping');
    ...
    public function render_pix_icon(renderer_base $output, pix_icon $icon) {
        ...
        return $output->render_from_template('core/pix_icon_forkawesome', $data);
    }
