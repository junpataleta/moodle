...
/**
 * Javascript handling for HTML attributes.
 * This module gets autoloaded on page load, Given you use appropriate HTML syntax
 * functionalities contained here can be used.
 * An example of this is calling a Moodle confirmation modal with little more than dom attributes.
 *
 * @module     core/utility
