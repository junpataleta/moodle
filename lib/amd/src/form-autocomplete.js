...
function($, log, str, templates, notification, LoadingIcon, Aria) {
    ...
    var activateSelection = function(index, state) {
        ...
        element.attr('data-active-selection', 1);
    ...
    var activatePreviousSelection = function(state) {
        ...
        // Find the active one.
        var element = selectionsElement.children('[data-active-selection=1]');
        if (!element) {
        ...
        selectionElement.on('keydown', function(e) {
            ...
            switch (e.keyCode) {
                ...
                case KEYS.ENTER:
                    ...
                    var selectedItem = $(document.getElementById(state.selectionId)).children('[data-active-selection=1]');
                    if (selectedItem) {
                        e.preventDefault();
