 ...
 */
define(['jquery', 'core/modal_events', 'core/modal_registry', 'core/modal', 'core/modal_save_cancel',
        'core/modal_cancel', 'core/templates', 'core/notification', 'core/custom_interaction_events', 'core/log'],
    function($, ModalEvents, ModalRegistry, Modal, ModalSaveCancel,
        ModalCancel, Templates, Notification, CustomEvents, Log) {
    ...
    // Point confirm modal type to save-cancel for backwards compatibility.
    ModalRegistry.register(TYPES.CONFIRM, ModalSaveCancel, TEMPLATES.SAVE_CANCEL);
     ...
     * @param {object} registryConf A config from the ModalRegistry
     * @param {object} templateContext The context data for the modal's template.
     * @param {object} triggerElement The trigger HTML jQuery object
