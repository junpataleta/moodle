 ...
 */
const IconSystemFont = function() {
    IconSystem.apply(this, arguments);
};
IconSystemFont.prototype = Object.create(IconSystem.prototype);
 ...
 * @return {Promise}
 */
IconSystemFont.prototype.init = function() {
    if (staticMap) {
        return Promise.resolve(this);
    }

    let map = LocalStorage.get('core/iconmap-font');
    if (map) {
        map = JSON.parse(map);
    }
    ...
    if (fetchMap === null) {
        fetchMap = Ajax.call([{
            methodname: 'core_output_load_icon_font_system_map',
            args: {
 ...
 * @method renderIcon
 */
IconSystemFont.prototype.renderIcon = function(key, component, title, template) {
 ...
 */
IconSystemFont.prototype.getTemplateName = function() {
    return 'core/pix_icon_forkawesome';
};

/** @alias module:core/icon_system_forkawesome */
export default IconSystemFont;
