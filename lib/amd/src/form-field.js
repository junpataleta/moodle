...
define(['jquery'],
    function($) {
         ...
         * Form field types.
         *
         * @type {{TEXT: number, SELECT: number, CHECKBOX: number, ATTO_EDITOR: number}}
         */
        FormField.TYPES = {
            TEXT: 1,
            SELECT: 2,
        ...
        FormField.prototype.setFieldValue = function(value) {
            ...
            switch (this.type) {
                case FormField.TYPES.CHECKBOX:
                    ...
                    break;
                case FormField.TYPES.ATTO_EDITOR:
                    if ($.type(value.text) !== 'undefined') {
                        $(this.selector + 'editable').html(value.text);
                    }
                    break;
                default:
