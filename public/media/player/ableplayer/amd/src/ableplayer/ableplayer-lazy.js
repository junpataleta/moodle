/**
 * @license
 * Able Player 5.0.0 <https://ableplayer.github.io/ableplayer/>
 * Copyright (c) 2014-2025 The Able Player Contributors
 * Available under the MIT License
 * <https://github.com/ableplayer/ableplayer/blob/main/LICENSE>
 *
 * Includes DOMPurify <https://github.com/cure53/DOMPurify>
 * Available under the Apache License Version 2.0 and the Mozilla Public License 2.0
 * <https://github.com/cure53/DOMPurify/blob/main/LICENSE>
 */

(function (ableplayerGlobal, ableplayerFactory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = ableplayerFactory(require('jquery')) :
  typeof define === 'function' && define.amd ? define(['jquery'], ableplayerFactory) :
  (ableplayerGlobal = typeof globalThis !== 'undefined' ? globalThis : ableplayerGlobal || self, ableplayerGlobal.AblePlayer = ableplayerFactory(ableplayerGlobal.jQuery));
  ...
  var validate = {
    ...
    sanitizeVttContent: function (vttContent) {
      ...
      var sanitizedVttContent = purify.sanitize(
  ...
  function addBuildplayerFunctions(AblePlayer) {
  	...
  	AblePlayer.prototype.injectAudioPoster = function() {
  		if ( this.mediaType === 'audio' && this.hasPoster ) {
  			const audioPoster = purify.sanitize(this.audioPoster);
  			const audioPosterAlt = purify.sanitize(this.audioPosterAlt);
