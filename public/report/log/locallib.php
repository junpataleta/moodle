...
function report_log_print_mnet_selector_form($hostid, $course, $selecteduser=0, $selecteddate='today',
    ...
    if (has_capability('report/log:view', $sitecontext) && $showcourses) {
        ...
        echo html_writer::label(get_string('selectacoursesite'), 'menuhost_course', false, ['class' => 'visually-hidden']);
        ...
        echo html_writer::label(get_string('selectacourse'), 'menuid', false, ['class' => 'visually-hidden']);
    ...
    if ($showgroups) {
        ...
        echo html_writer::label(get_string('selectagroup'), 'menugroup', false, ['class' => 'visually-hidden']);
        echo html_writer::select($groups, "group", $selectedgroup, get_string("allgroups"));
    }

    if ($showusers) {
        echo html_writer::label(get_string('participantslist'), 'menuuser', false, ['class' => 'visually-hidden']);
    ...
    echo html_writer::label(get_string('date'), 'menudate', false, ['class' => 'visually-hidden']);
    echo html_writer::select($dates, "date", $selecteddate, false);
    echo html_writer::label(get_string('showreports'), 'menumodid', false, ['class' => 'visually-hidden']);
    echo html_writer::select($activities, "modid", $selectedactivity, get_string("allactivities"));
    echo html_writer::label(get_string('actions'), 'menumodaction', false, ['class' => 'visually-hidden']);
    ...
    echo html_writer::label(get_string('logsformat', 'report_log'), 'menulogformat', false, ['class' => 'visually-hidden']);
