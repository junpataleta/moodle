...
class dndupload_ajax_processor {
     ...
     */
    public function process($displayname = null, $content = null, $imagedetails = null) {
    ...
    public static function sanitise_image_details(array $imagedetails): array {
        ...
        $alt = isset($imagedetails['alt'])
            ? core_text::substr((string) $imagedetails['alt'], 0, self::IMAGE_ALT_MAXLENGTH)
            : '';
