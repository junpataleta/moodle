...
$string['notificationctafeedbackbody'] = 'The site feedback survey is how admins tell Moodle HQ what to fix and what to build. Turning it on takes one setting.';
...
$string['notificationctamarketplacebody'] = 'The new home for Moodle plugins and integrations, replacing the Plugins directory.';
$string['notificationctamarketplacecaption'] = 'Opens marketplace.moodle.com in a new window.';
$string['notificationctamarketplacecta'] = 'Browse the Marketplace';
...
$string['notificationctamoodlecloudbody'] = 'Need a second site for a pilot, a course build or a client? Get Moodle hosted by Moodle, with nothing to maintain.';
...
$string['notificationctapartnersbody'] = 'Work with a Moodle Certified Service Provider near you for hosting, upgrades, integrations or custom development.';
$string['notificationctapartnerscaption'] = 'Certified and continuously assessed by Moodle.';
$string['notificationctapartnerscta'] = 'Find a Partner';
...
$string['notificationctapartnerstitle'] = 'Certified Moodle Partners';
...
$string['oauth2server_clientrevoke'] = 'Revoke';
$string['oauth2server_clientrevokeactiondesc'] = 'This immediately revokes all active secrets and stops the client from authenticating. The client and its configuration are kept, and it can be re-enabled later. To permanently remove it instead, revoke it first, then delete.';
...
$string['oauth2server_expirycolumn_help'] = 'Expiration dates and times are displayed in your preferred time zone ({$a}).';
$string['oauth2server_managesecrets'] = 'Manage secrets';
$string['oauth2server_noactivesecrets'] = '<i class="fa fa-circle-info me-2"></i><strong>No active client secrets are currently configured.</strong> <br /><br /> This OAuth 2 client cannot be used for authentication until an active client secret is added. <br /> Generate a new secret below to enable authentication.';
...
$string['oauth2server_secretsnotavailablerevokedclient'] = 'This OAuth 2 client has been revoked and cannot support client secrets until it is re-enabled.';
