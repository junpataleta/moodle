...
$string['unconvertedpdffonts'] = 'These fonts were added for PDF generation, but are in the older TCPDF format, which can no longer be read when generating PDFs such as report exports. Any PDF configured to use one of them is silently generated with the default font instead.';
$string['unconvertedpdffontsfix'] = 'Convert each one again from its original .ttf or .otf file with <code>admin/cli/convert_pdf_font.php</code>. Leave the existing files in place: they are still used for PDF annotation and for the accessibility report.';
