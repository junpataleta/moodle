...
$string['dndimagealt'] = 'Alternative text';
$string['dndimagealtdescription'] = 'How would you describe this image to someone who cannot see it?';
$string['dndimagealtrequired'] = 'An image must have a description, unless it is marked as decorative only.';
$string['dndimagecustom'] = 'Custom';
$string['dndimagedecorative'] = 'Decorative image';
$string['dndimagedetailstitle'] = 'Image details';
$string['dndimageheight'] = 'Height';
$string['dndimageoriginal'] = 'Original';
$string['dndimagesize'] = 'Image size';
$string['dndimagesizehint'] = 'Width and height adjust together to keep the original proportions.';
$string['dndimagewidth'] = 'Width';
