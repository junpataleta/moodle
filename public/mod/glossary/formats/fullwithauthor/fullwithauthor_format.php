...
/**
 * Displays a glossary entry in full format with its author.
 *
 ...
 */
function glossary_show_entry_fullwithauthor(
    $course,
    $cm,
    $glossary,
    $entry,
    ...
    if ($entry) {
        ...
        echo '<div class="glossarypost fullwithauthor">';
...
/**
 * Display entries in the full, with author glossary format for printing.
 *
 * @param stdClass $course The course object.
 * @param stdClass $cm The course module object.
 * @param stdClass $glossary The glossary object.
 ...
 * @package mod_glossary
 */
function glossary_print_entry_fullwithauthor(
    $course,
    $cm,
    $glossary,
    $entry,
    ...
    glossary_show_entry_fullwithauthor($course, $cm, $glossary, $entry, $mode, $hook, false, false, $conceptheadinglevel);
}
