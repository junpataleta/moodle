...
class manager {
    ...
    public static function update_shipped_tours() {
        ...
        $shippedtours = [
            '311_activity_completion_activity_page_student.json' => 1,
            '311_activity_completion_activity_page_teacher.json' => 1,
            '311_activity_completion_course_page_student.json' => 1,
            '311_activity_completion_course_page_teacher.json' => 1,
        ];
