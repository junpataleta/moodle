...
$string['createdeletedatarequest'] = 'Create delete data request';
...
$string['dataprivacy:managedatadeletionrequests'] = 'Request delete for another user';
$string['dataprivacy:requestdelete'] = 'Request delete for yourself';
