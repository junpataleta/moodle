...
Feature: Preview a Matching question
  ...
  Scenario: Preview a Matching question and submit a correct response.
    ...
    And I set the field "frog" to "amphibian"
    And I set the field "cat" to "mammal"
    And I set the field "newt" to "amphibian"
    And I press "Check"
  ...
  Scenario: Preview a Matching question and submit a partially correct response.
    ...
    And I press "Save preview options and start again"
    And I set the field "frog" to "amphibian"
    And I set the field "cat" to "insect"
    And I set the field "newt" to "amphibian"
    And I press "Check"
  ...
  Scenario: Preview a Matching question and submit an incorrect response.
    ...
    And I set the field "How questions behave" to "Immediate feedback"
    And I press "Save preview options and start again"
    And I set the field "frog" to "mammal"
    And I set the field "cat" to "insect"
    And I set the field "newt" to "insect"
    And I press "Check"
