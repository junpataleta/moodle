...
class qtype_essay_renderer extends qtype_renderer {
    ...
    public function files_read_only(question_attempt $qa, question_display_options $options) {
        ...
        $fileslabel = $options->get_answer_field_label(
            'answerfiles', 'qtype_essay', 'answerfilesquestionnum', 'qtype_essay', $options->questionnumber
        );
...
class qtype_essay_format_editor_renderer extends qtype_essay_format_renderer_base {
    ...
    public function response_area_read_only($name, $qa, $step, $lines, $context) {
        ...
        $responselabel = $this->displayoptions->get_answer_field_label(
            'answertext', 'qtype_essay', 'answertextquestionnum', 'qtype_essay', $this->displayoptions->questionnumber
        );
