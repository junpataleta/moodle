...
abstract class qtype_multianswer_subq_renderer_base extends qtype_renderer {
    ...
    protected function get_answer_label(
        ...
        string $langkeywithquestion = 'answerxquestiony',
        ...
        $questionnumber = $this->displayoptions->questionnumber ?? '';
        ...
        if ($questionnumber !== '') {
            $params = (object) [
                'number' => self::$answercount[$questionnumberindex][$langkey],
                'question' => $questionnumber,
            ];
        } else {
            $params = self::$answercount[$questionnumberindex][$langkey];
        }
        return $this->displayoptions->get_answer_field_label(
            $langkey, $component, $langkeywithquestion, $component, $params
        );
    }
}
