...
/**
 * Contains the base class for defining an activity module's custom completion rules and fetching the completion statuses
...
abstract class activity_custom_completion {
     ...
     */
    public function validate_rule(string $rule) {
    ...
    public static function get_cm_completion_class(string $modname): ?string {
        $cmcompletionclass = "mod_{$modname}\\completion\\custom_data";
