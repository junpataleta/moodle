...
define(['jquery', 'core/form-autocomplete', 'core/str', 'core/notification'],
     ...
     */
    var init = function() {
        Str.get_string('nofiltersapplied', 'moodle').done(function(noSelectionString) {
            Autocomplete.enhance(SELECTORS.UNIFIED_FILTERS, true, 'core_user/unified_filter_datasource', '',
