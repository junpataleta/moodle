...
define(['core/templates',
    ...
    function(Template, $, Str, Config, Notification, ModalFactory, ModalEvents, Fragment) {
        ...
        EditEnrolment.prototype.initModal = function() {
            var triggerButtons = $('.editenrolmentbutton');
         ...
         * @return {Promise}
         */
        EditEnrolment.prototype.getBody = function() {
            return Fragment.loadFragment('enrol', 'user_enrolment_form', this.contextid, {}).fail(Notification.exception);
        };
