...
class edit_questions_form extends moodleform {
    ...
    protected function definition() {
        ...
        // Hidden elements.
        $mform->addElement('hidden', 'threesixtyid');
        $mform->setType('threesixtyid', PARAM_INT);
        ...
        $feedbacktypeoptions = array(
            api::QTYPE_RATED => get_string('qtyperated', 'threesixty'),
            api::QTYPE_COMMENT => get_string('qtypecomment', 'threesixty'),
        );
