...
function mod_book_get_fontawesome_icon_map() {
    return [
        'mod_book:chapter' => 'far fa-bookmark',
        'mod_book:nav_prev' => 'fa fa-arrow-left',
        'mod_book:nav_prev_dis' => 'fa fa-angle-left',
        'mod_book:nav_sep' => 'fa fa-minus',
        'mod_book:add' => 'fa fa-plus',
        'mod_book:nav_next' => 'fa fa-arrow-right',
        'mod_book:nav_next_dis' => 'fa fa-angle-right',
        'mod_book:nav_exit' => 'fa fa-arrow-up',
    ];
}
