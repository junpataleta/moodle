...
$string['csvwithselecteddelimiter'] = '<abbr title="Comma Separated Values">CSV</abbr> text with selected delimiter:';
...
$string['fieldtypedescription'] = '({$a->type}) {$a->description}';
