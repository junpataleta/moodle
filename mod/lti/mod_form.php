...
class mod_lti_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        // Array of tool type IDs that support ContentItemSelectionRequest.
        $contentitemtypes = [];
        ...
        // Add button that launches the content-item selection dialogue. Disable this by default.
        ...
        $mform->disabledIf('selectcontent', 'typeid', 'neq', $contentitemtypes);
        ...
        if ($update) {
            ...
            $mform->disabledIf('toolurl', 'typeid', 'eq', $noncontentitemtypes);
        }
        ...
        if ($update) {
            ...
            $mform->disabledIf('securetoolurl', 'typeid', 'eq', $noncontentitemtypes);
        }
        ...
        if ($update) {
            ...
            $mform->disabledIf('resourcekey', 'typeid', 'eq', $noncontentitemtypes);
        }
        ...
        if ($update) {
            ...
            $mform->disabledIf('password', 'typeid', 'eq', $noncontentitemtypes);
        }
        ...
        if ($update) {
            ...
            $mform->disabledIf('icon', 'typeid', 'eq', $noncontentitemtypes);
        }
        ...
        if ($update) {
            ...
            $mform->disabledIf('secureicon', 'typeid', 'eq', $noncontentitemtypes);
        }
