...
class mod_lti_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        // Conditionally enable if the selected value supports Content-Item selection.
        $selectedtooltypes = empty($tooltypes->getValue()) ? 0 : $tooltypes->getSelected();
        $configurebuttonattributes = ['disabled' => 'disabled'];
        if (!empty($selectedtooltypes)) {
