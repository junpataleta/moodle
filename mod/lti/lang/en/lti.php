...
$string['configurefromlink'] = 'Configure tool from link';
$string['contentitem'] = 'Content-item message';
$string['contentitem_help'] = 'If checked, the tool provider will participate in the creation of new links added to courses.';
$string['contentitemtoolregistrationsuccess'] = 'Successfully created a new tool.';
...
$string['toolconfigbycontentitemcancelled'] = 'Tool configuration from link was cancelled.';
