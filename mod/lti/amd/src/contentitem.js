 ...
 * @since      3.2
 */
define(['jquery', 'core/notification', 'core/str', 'core/templates', 'core/form-field', 'core/yui'],
    function($, notification, str, templates, FormField) {
        ...
        var ltiFormFields = [
            ...
            new FormField('introeditor', FormField.TYPES.ATTO_EDITOR, false, ''),
            new FormField('typeid', FormField.TYPES.SELECT, false, 0),
