...
Feature: Set time spent as a completion condition for a lesson
  ...
  Scenario: Set time spent as a condition
    ...
    Then the "Spend at least 10 secs in the lesson" completion condition of "Test lesson" is displayed as "todo"
    And I follow "Test lesson"
    ...
    And I am on "Course 1" course homepage
    And the "Spend at least 10 secs in the lesson" completion condition of "Test lesson" is displayed as "todo"
    And I am on "Course 1" course homepage
    And I follow "Test lesson"
    And I press "Next page"
    ...
    And I am on "Course 1" course homepage
    And the "Spend at least 10 secs in the lesson" completion condition of "Test lesson" is displayed as "done"
    And I log out
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
