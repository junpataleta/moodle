...
Feature: Set end of lesson reached as a completion condition for a lesson
  ...
  Scenario: Set end reached as a condition
    ...
    Then the "Reach the end of the lesson page" completion condition of "Test lesson" is displayed as "todo"
    And I follow "Test lesson"
    And I press "Next page"
    And I am on "Course 1" course homepage
    And the "Reach the end of the lesson page" completion condition of "Test lesson" is displayed as "todo"
    And I am on "Course 1" course homepage
    And I follow "Test lesson"
    ...
    And I press "Next page"
    And I am on "Course 1" course homepage
    And the "Reach the end of the lesson page" completion condition of "Test lesson" is displayed as "done"
    And I log out
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
