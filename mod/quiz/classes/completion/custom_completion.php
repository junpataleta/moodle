 ...
 *
 * Contains the class for defining mod_quiz's custom completion rules and fetching the completion statuses
 * of the custom completion rules for a given quiz instance and a user.
 *
 * @package   mod_quiz
 * @copyright Shamim Rezaie 2021 <shamim@moodle.com>
...
class custom_completion extends activity_custom_completion {
    ...
    public function get_custom_rule_descriptions(): array {
        ...
        if ($this->cm->customdata['customcompletionrules']['completionpassorattemptsexhausted']['completionattemptsexhausted']) {
