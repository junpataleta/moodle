...
trait submission_legacy_polyfill {
     ...
     * - user object
     *
     * @param  submission_request_data $exportdata Information to use to export user data for this sub-plugin.
     */
    public static function export_submission_user_data(submission_request_data $exportdata) {
     ...
     * - assign object
     *
     * @param submission_request_data $requestdata Information to use to delete user data for this submission.
     */
    public static function delete_submission_for_context(submission_request_data $requestdata) {
     ...
     */
    public static function delete_submission_for_userid(submission_request_data $exportdata) {
