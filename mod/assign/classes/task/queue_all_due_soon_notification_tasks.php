 ...
 */
class queue_all_due_soon_notification_tasks extends scheduled_task {
    ...
    public function execute(): void {
        $assignments = notification_helper::get_assignments_within_date_range();
        foreach ($assignments as $assignment) {
            $task = new queue_assignment_due_notification_tasks_for_users();
