...
class assignfeedback_editpdf_privacy_testcase extends \mod_assign\tests\mod_assign_privacy_testcase {
    ...
    protected function create_feedback($assign, $student, $teacher) {
        ...
        \assignfeedback_editpdf\document_services::generate_feedback_document($assign->get_instance()->id, $student->id,
                $grade->attemptnumber);
    ...
    public function test_export_feedback_user_data() {
        ...
        $exportdata = new \mod_assign\privacy\feedback_request_data($context, $plugin, $grade, [], $user1, $assign);
        \assignfeedback_editpdf\privacy\provider::export_feedback_user_data($exportdata);
        $pdffile = $writer->get_files(['PDFfeedback'])['PDF Feedback'][0];
    ...
    public function test_delete_feedback_for_context() {
        ...
        $requestdata = new feedback_request_data($context, $plugin1);
    ...
    public function test_delete_feedback_for_grade() {
        ...
        $requestdata = new feedback_request_data($context, $plugin1, $grade1, [], $user1, $assign);
