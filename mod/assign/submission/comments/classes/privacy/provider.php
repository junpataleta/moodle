...
class provider implements metadataprovider, \mod_assign\privacy\assignsubmission_provider {
    ...
    public static function export_submission_user_data(submission_request_data $exportdata) {
        ...
        $userid = ($exportdata->get_user() != null) ? $exportdata->get_user()->id : null;
     ...
     *
     * @param  submission_request_data $requestdata Data to fulfill the deletion request.
     */
    public static function delete_submission_for_context(submission_request_data $requestdata) {
        comments_provider::delete_comments_for_all_users_in_context($requestdata->get_context());
    }
    ...
    public static function delete_submission_for_userid(submission_request_data $exportdata) {
        ...
        comments_provider::delete_comments_for_user($contextlist);
    }
}
