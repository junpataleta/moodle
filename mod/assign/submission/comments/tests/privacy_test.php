...
class assignsubmission_comments_privacy_testcase extends \mod_assign\tests\mod_assign_privacy_testcase {
    ...
    public function test_get_student_user_ids() {
        ...
        $this->assertEquals($user1->id, $useridlist->get_userids()[0]->userid);
    }
    ...
    public function test_export_submission_user_data() {
        ...
        $exportdata = new \mod_assign\privacy\submission_request_data($context, $plugin, $submission, [], null, $assign);
    ...
    public function test_delete_submission_for_context() {
        ...
        $requestdata = new \mod_assign\privacy\submission_request_data($context);
    ...
    public function test_delete_submission_for_userid() {
        ...
        $requestdata = new \mod_assign\privacy\submission_request_data($context, null, null, [], $user1);
