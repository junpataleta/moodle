...
class provider implements metadataprovider, \mod_assign\privacy\assignsubmission_provider {
    ...
    public static function export_submission_user_data(submission_request_data $exportdata) {
        ...
        $submission = $exportdata->get_submission();
    ...
    public static function delete_submission_for_userid(submission_request_data $exportdata) {
        ...
        // Delete related files.
        $fs = get_file_storage();
        $fs->delete_area_files($exportdata->get_context()->id, 'assignsubmission_onlinetext', ASSIGNSUBMISSION_ONLINETEXT_FILEAREA,
                $submissionid);

        // Delete the records in the table.
        $DB->delete_records('assignsubmission_onlinetext', ['assignment' => $exportdata->get_assign()->get_instance()->id,
