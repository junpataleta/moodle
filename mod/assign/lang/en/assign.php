...
$string['assignmentduedatesoonhtml'] = '<p>Hi {$a->firstname},</p>
<p>The assignment <strong>{$a->assignmentname}</strong> in course {$a->coursename} is due soon.
<p><strong>Due: {$a->duedate}</strong></p>
<p><a href="{$a->url}">Go to activity</a></p>';
$string['assignmentduedatesoonsubject'] = 'Due on {$a->duedate}: {$a->assignmentname}';
...
$string['messageprovider:assign_duedate_soon'] = 'Assignment due soon notification';
