...
class mod_assign_privacy_testcase extends provider_testcase {
    ...
    public function test_export_user_data_student() {
        ...
        // Check feedback.
        $this->assertEquals($teachercommenttext, $writer->get_data(['attempt 1', 'Feedback comments'])->commenttext);
        $this->assertEquals($teachercommenttext2, $writer->get_data(['attempt 2', 'Feedback comments'])->commenttext);
    }
    ...
    public function test_export_user_data_teacher() {
        ...
        $this->assertEquals($teachercommenttext, $writer->get_data(['studentsubmissions', $user1->id, 'attempt 1',
                'Feedback comments'])->commenttext);
        $this->assertEquals($teachercommenttext2, $writer->get_data(['studentsubmissions', $user2->id, 'attempt 1',
                'Feedback comments'])->commenttext);
        $this->assertEquals($teachercommenttext3, $writer->get_data(['studentsubmissions', $user2->id, 'attempt 2',
                'Feedback comments'])->commenttext);
    }
