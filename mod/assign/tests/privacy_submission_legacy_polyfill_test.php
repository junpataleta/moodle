...
class mod_assignsubmission_privacy_legacy_polyfill_test extends advanced_testcase {
    ...
    public function test_export_submission_user_data() {
        ...
        $requestdata = new \mod_assign\privacy\submission_request_data($context, $subplugin);
        $mock = $this->createMock(test_assignsubmission_legacy_polyfill_mock_wrapper::class);
        $mock->expects($this->once())
            ->method('get_return_value')
...
class test_legacy_polyfill_submission_provider implements \mod_assign\privacy\assignsubmission_provider {
    ...
    /**
     * This method is used to export any user data this sub-plugin has using the submission_request_data object to get the
     * context and userid.
     * submission_request_data contains:
     * - context
     * - submission plugin
     * - grade object
     ...
     * - user object
     *
     * @param  submission_request_data $exportdata Contains data to help export the user information.
     */
    public static function _export_submission_user_data(\mod_assign\privacy\submission_request_data $exportdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
     ...
     * - assign object
     *
     * @param  submission_request_data $requestdata Data useful for deleting user data from this sub-plugin.
     */
    public static function _delete_submission_for_context(\mod_assign\privacy\submission_request_data $requestdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
     ...
     * - assign object
     *
     * @param  submission_request_data $requestdata Data useful for deleting user data.
     */
    public static function _delete_submission_for_userid(\mod_assign\privacy\submission_request_data $requestdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
}
/**
