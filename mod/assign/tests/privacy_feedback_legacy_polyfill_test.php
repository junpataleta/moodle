...
class mod_assignfeedback_privacy_legacy_polyfill_test extends advanced_testcase {
    ...
    public function test_export_feedback_user_data() {
        ...
        $requestdata = new \mod_assign\privacy\feedback_request_data($context, $subplugin);
        $mock = $this->createMock(test_assignfeedback_legacy_polyfill_mock_wrapper::class);
        $mock->expects($this->once())
            ->method('get_return_value')
...
class test_legacy_polyfill_feedback_provider implements \mod_assign\privacy\assignfeedback_provider {
     ...
     * feedback_request_data contains:
     * - context
     * - feedback plugin
     * - grade object
     ...
     * - user object
     *
     * @param  feedback_request_data $exportdata Contains data to help export the user information.
     */
    public static function _export_feedback_user_data(\mod_assign\privacy\feedback_request_data $exportdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
     ...
     */
    public static function _delete_feedback_for_context(\mod_assign\privacy\feedback_request_data $requestdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
     ...
     */
    public static function _delete_feedback_for_grade(\mod_assign\privacy\feedback_request_data $requestdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
}
/**
