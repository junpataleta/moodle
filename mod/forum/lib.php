...
function mod_forum_get_fontawesome_icon_map() {
    return [
        'mod_forum:i/pinned' => 'fa fa-map-pin',
        'mod_forum:t/selected' => 'fa fa-check',
        'mod_forum:t/subscribed' => 'far fa-envelope',
        'mod_forum:t/unsubscribed' => 'far fa-envelope-open',
        'mod_forum:t/star' => 'fa fa-star',
    ];
}
