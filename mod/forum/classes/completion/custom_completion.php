 ...
 *
 * Contains the class for defining mod_forum's custom completion rules and fetching the completion statuses
...
class custom_completion extends activity_custom_completion {
    ...
    public function get_custom_rule_descriptions(): array {
        return [
            'completiondiscussions' => get_string('completiondetail:discussions', 'forum'),
            'completionreplies' => get_string('completiondetail:replies', 'forum'),
            'completionposts' => get_string('completiondetail:posts', 'forum'),
        ];
    }
}
