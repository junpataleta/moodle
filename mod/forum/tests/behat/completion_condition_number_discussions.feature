...
Feature: Set a certain number of discussions as a completion condition for a forum
  ...
  Scenario: Set X number of discussions as a condition
    ...
    And the "Create discussion" completion condition of "Test forum name" is displayed as "todo"
    ...
    And I am on "Course 1" course homepage
    Then the "Create discussion" completion condition of "Test forum name" is displayed as "done"
    And I log out
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
