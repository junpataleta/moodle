    ...
    public function get_state_provider(): array {
        return [
            ...
            'Completion discussions rule not available'  => [
                'completiondiscussions', COMPLETION_DISABLED, false, null, moodle_exception::class
            ],
            'Completion discussions rule available, user has not created discussion' => [
                'completiondiscussions', COMPLETION_ENABLED, false, COMPLETION_INCOMPLETE, null
            ],
            'Rule available, user has created discussion' => [
                'completiondiscussions', COMPLETION_ENABLED, true, COMPLETION_COMPLETE, null
            ],
            'Completion replies rule not available' => [
                'completionreplies', COMPLETION_DISABLED, false, null, moodle_exception::class
            ],
            'Rule available, user has not replied' => [
                'completionreplies', COMPLETION_ENABLED, false, COMPLETION_INCOMPLETE, null
            ],
            'Rule available, user has replied' => [
                'completionreplies', COMPLETION_ENABLED, true, COMPLETION_COMPLETE, null
            ],
            'Completion posts rule not available' => [
                'completionposts', COMPLETION_DISABLED, false, null, moodle_exception::class
            ],
            'Rule available, user has not posted' => [
                'completionposts', COMPLETION_ENABLED, false, COMPLETION_INCOMPLETE, null
            ],
            'Rule available, user has posted' => [
                'completionposts', COMPLETION_ENABLED, true, COMPLETION_COMPLETE, null
            ],
        ];
    }
    ...
    public function test_get_state(string $rule, int $available, ?bool $submitted, ?int $status, ?string $exception) {
        ...
        if ($submitted) {
            if ($rule == 'completiondiscussions') {
                ...
                $forumgenerator->create_discussion((object) $forumgenparams);
            }
            ...
            if ($rule == 'completionposts'  && $submitted == true) {
