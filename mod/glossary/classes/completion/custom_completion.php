 ...
 *
 * Contains the class for defining mod_glossary's custom completion rules and fetching the completion statuses
...
class custom_completion extends activity_custom_completion {
    ...
    public function get_state(string $rule): int {
        ...
        if ($rule == 'completionentries') {
            ...
            $status = $completionentries <= $userentries;
        }
    ...
    public function get_custom_rule_descriptions(): array {
        return [
            'completionentries' => get_string('completiondetail:entries', 'glossary'),
        ];
    }
}
