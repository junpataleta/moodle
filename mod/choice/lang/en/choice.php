...
$string['publishafteranswer_info'] = 'The results will be shown after you answer';
$string['publishafterclose'] = 'Show results to students only after the choice is closed';
$string['publishafterclose_info'] = 'The results will be shown to students after the choice is closed';
...
$string['publishanonymous_info'] = 'The results will be published anonymously. Your choice(s) will not be attributed to you';
$string['publishnames'] = 'Publish full results, showing names and their choices';
$string['publishnames_info'] = 'The results will be published including your name and your choice(s)';
$string['publishnot'] = 'Do not publish results to students';
$string['publishnot_info'] = 'The results of this activity will not be published to students';
