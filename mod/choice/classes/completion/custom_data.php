...
/**
 * Contains the class for defining mod_choice's custom completion rules and fetching the completion statuses
 * of the custom completion rules for a given choice instance and a user.
 *
 * @package   mod_choice\completion
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class custom_data extends activity_custom_completion {
    ...
    public static function get_custom_rule_descriptions(): array {
        return [
            'completionsubmit' => get_string('completionsubmit', 'choice')
        ];
    }
}
