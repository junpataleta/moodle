...
class gradingform_rubric_renderer extends plugin_renderer_base {
    ...
    public function criterion_template($mode, $options, $elementname = '{NAME}', $criterion = null, $levelsstr = '{LEVELS}', $value = null) {
        ...
        if ($mode == gradingform_rubric_controller::DISPLAY_EDIT_FULL) {
            ...
            $descriptionlabel = html_writer::tag('label', get_string('criterion', 'gradingform_rubric', ''),
        ...
        $levelstablelabelparams = array('class' => 'accesshide', 'for' => '{NAME}-criteria-{CRITERION-id}-levels-table');
        $levelstablelabel = html_writer::tag('label', get_string('levelsgroup', 'gradingform_rubric'), $levelstablelabelparams);
        ...
        if ($displayremark) {
            ...
            $remarklabelparams = array('class' => 'accesshide', 'for' => '{NAME}-criteria-{CRITERION-id}-remark');
            $remarklabel = html_writer::tag('label', $remarklabeltext, $remarklabelparams);
    ...
    public function level_template($mode, $options, $elementname = '{NAME}', $criterionid = '{CRITERION-id}', $level = null) {
        ...
        if ($mode == gradingform_rubric_controller::DISPLAY_EDIT_FULL) {
            ...
            $definitionlabelparams = array(
                ...
                'for' => '{NAME}-criteria-{CRITERION-id}-levels-{LEVEL-id}-definition',
                'class' => 'accesshide'
            );
            $definitionlabeltext = get_string('leveldefinition', 'gradingform_rubric', $levelindex);
            $definitionlabel = html_writer::tag('label', $definitionlabeltext, $definitionlabelparams);
        ...
        if ($mode == gradingform_rubric_controller::DISPLAY_EVAL) {
            ...
            $radioparams = array('class' => 'radio', 'role' => 'radio');
            $leveltemplate .= html_writer::tag('div', $input, $radioparams);
        }
        ...
        $leveltemplate .= html_writer::tag('div', $definition . $definitionlabel, $leveltemplateparams);
        $displayscore = true;
    ...
    protected function rubric_template($mode, $options, $elementname, $criteriastr) {
        ...
        // Hidden rubric label.
        $rubriclabelparams = array('class' => 'accesshide', 'for' => '{NAME}-criteria');
        $rubriclabel = html_writer::tag('label', get_string('rubric', 'gradingform_rubric'), $rubriclabelparams);
