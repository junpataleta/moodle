...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect('grade_report_user_showgradeandpercentage',
                        get_string('showgradeandpercentage', 'grades'),
                        get_string('showgradeandpercentage_help', 'grades'),
                        GRADE_REPORT_SHOW_BOTH, $showoptions));
