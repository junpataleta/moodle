...
class grade_report_user extends grade_report {
    ...
    public function __construct($courseid, $gpr, $context, $userid, $viewasuser = null) {
        ...
        $showgradeandpercentage = grade_get_setting($this->courseid,
                                                    'report_user_showgradeandpercentage',
                                                    $CFG->grade_report_user_showgradeandpercentage);
...
function grade_report_user_settings_definition(&$mform) {
    ...
    $mform->addElement('select',
                       'report_user_showgradeandpercentage',
                       get_string('showgradeandpercentage',
                       'grades'),
                       $showoptions);
