...
Feature: Run tests over my courses.
  ...
  Scenario: Admin can see relevant blocks but not add or move them
    ...
    And "Move Text on all pages block" "icon" should exist in the "Text on all pages" "block"
    ...
    And I should see "This is visible on all pages"
    And "Move Text on all pages block" "icon" should not exist in the "Text on all pages" "block"
    And "Move Course overview block" "icon" should not exist in the "Course overview" "block"
