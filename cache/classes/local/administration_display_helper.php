...
use cache_definition_sharing_form;
use cache_exception;
use cache_factory;
use cache_helper;
use cache_lock_form;
use cache_mode_mappings_form;
use cache_store;
use cachestore_addinstance_form;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class administration_display_helper extends administration_helper {
